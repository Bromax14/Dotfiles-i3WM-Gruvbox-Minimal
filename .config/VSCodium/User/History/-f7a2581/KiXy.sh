...
option=$(printf "Ver Info Completa" | rofi \
    -dmenu \
    -p "Info Sistema" \
    -theme-str 'window {width: 250px; height: 120px; location: center; anchor: center; border: 0px; border-radius: 0px; background-color: #FFFFFF; border-color: #FFFFFF;}' \
    ...
    -theme-str 'element-text {horizontal-align: 0.0; vertical-align: 1.0; font: "Adwaita Sans 10"; text-color: #e6ddb7;}' \
